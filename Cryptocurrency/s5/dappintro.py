...
contracts = {
	...
	# address, above.
	'poll': '0x5aF6f2FEaAB91F253AC3131F9ce39985164c3300',
...
other = {
	...
	'txn_hash_vote_yours': "0x40afc84363f070be2b733f6fe386ab7d2f0bde583583b16e848091087e044905",

	# This is the transaction hash where you voted on the course Polls
	# contract in part 5 (vote) of the assignment.
	'txn_hash_vote_course': "0x73ef1ae073533f697546d682382f9be5ee7b116994db395f93ddece420f4d24b",
	...
	'poll_purpose': "Vote on your favorite pet animal",
...
comments = {
	...
	# None).
	'comments': "I thought the choices for the course wide poll is clever to see if people actually explored it and didn't just pick choice 0 to fly through the hw. ",
}
