...
contracts = {
	...
	'auctioneer': '0x0596B69ac4Ca6CD4660F887a5F39ce108E1E5432',
...
other = {
	...
	'course_auction_id': 16,

	# This is the NFT token ID, in the class-wide NFT manager, for the above
	# auction.
	'course_nft_token_id': 49490064069870756997393445489578967511570908894183557356835495063523329835008,
...
comments = {
	...
	'suggestions': "I thought this hw was very cool. I would only suggest making the requirements section of the behavior more clear. I found it a little tedious at the end trying to figure out exactly all of the requirements to check",
