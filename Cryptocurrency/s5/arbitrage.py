...
comments = {
	...
	'suggestions': "Just clean up order of assignment information in general please. I think sometimes the info on requirements is scattered and leads to more confusion",
