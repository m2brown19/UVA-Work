...
contracts = {
	...
	# address, above.
	'dao': '0x8f8F78c6Bf8aFD02C948Bcf5DDCa61c40b94B1a5',
...
other = {
	...
	'dao_vote_txn': "0x25ed28acbdd70c81d761de0d45979e9abd5709f6f26e94bfbd6fb1f09936d24b",

	# What is the 8 hex digit suffix for your dao_XXXXXXXX.html file?  Just
	# the 8 hex digits, please.
	'dao.html_suffix': "ebd60b4d",
...
sanity_checks = {
	...
	# userid? I believe this is outdated and should be the suffix
...
comments = {
	...
	# None).
	'comments': "i thought this hw was cool to do. i enjoyed seeing the web interaction",
}
